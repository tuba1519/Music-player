...
root = Tk()
root.title("Harsh's Player")
root.geometry("485x700+500+35")
...
Playlist = Listbox(Frame_Music, width=100, font=("Times new roman", 10), bg="#333333", fg="grey", selectbackground="black", cursor="hand2", bd=0, yscrollcommand=Scroll.set)
